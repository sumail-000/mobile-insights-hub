    ...
    <div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                <Link href={`/phone-finder?brand=${encodeURIComponent(brandName)}`}
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {phones.map((phone) => (
            <Link key={phone.slug} href={`/phone/${phone.slug}`}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 pt-2.5 border-t border-white/8">
                  ...
                  <Link href="/compare" onClick={e => e.stopPropagation()} className="glass border border-white/10 text-xs font-semibold px-2.5 py-1 rounded-lg hover:border-primary/30 transition-all text-muted-foreground hover:text-primary flex items-center gap-1">
...
export default function BrandsPage() {
  return <Suspense><BrandsPageInner /></Suspense>;
}
