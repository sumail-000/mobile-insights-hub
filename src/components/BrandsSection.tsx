        ...
        <div className="relative">
          ...
          >
            {brands.map((brand, i) => (
              ...
              >
                <div
                  className="w-24 h-16 rounded-lg flex items-center justify-center border border-white/60 backdrop-blur-sm group-hover:border-primary/40 group-hover:shadow-md transition-all"
                  style={{ backgroundColor: brand.bg + "cc" }}
                >
          ...
          <button
            ...
            className="absolute right-0 top-7 -translate-y-1/2 glass-card rounded-full p-1.5 shadow-md hover:border-primary/50 transition-colors hidden md:flex"
          >
