...
function PhoneCard({ phone }: { phone: Phone }) {
  return (
    <a href="#" className="flex flex-col shrink-0 w-44 bg-card border border-border rounded-xl overflow-hidden hover:shadow-md hover:border-primary/30 transition-all group">
      {/* Phone image area */}
      <div className="relative h-44 flex items-center justify-center" style={{ backgroundColor: phone.bgColor }}>
        ...
        {/* Phone silhouette */}
        <div className="w-20 h-36 rounded-2xl border-2 relative flex flex-col" style={{ borderColor: phone.accentColor, backgroundColor: phone.accentColor + "22" }}>
          <div className="w-8 h-1.5 rounded-full mx-auto mt-2" style={{ backgroundColor: phone.accentColor + "88" }}></div>
          <div className="flex-1 mx-1.5 my-1.5 rounded-lg" style={{ backgroundColor: phone.accentColor + "44" }}></div>
    ...
    <section className="max-w-screen-xl mx-auto px-4 py-3">
      <div className="bg-card rounded-xl border border-border shadow-sm p-5">
        ...
        <div className="relative">
          ...
          <button onClick={() => scroll("right")} className="absolute -right-2 top-1/2 -translate-y-1/2 bg-card border border-border rounded-full p-1.5 shadow-md hover:border-primary/50 transition-colors hidden md:flex z-10">
