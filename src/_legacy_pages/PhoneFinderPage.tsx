                    ...
                    <div className="p-4 sm:p-5 flex gap-4 sm:gap-5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between gap-2 pt-2.5 border-t border-white/8 flex-wrap">
                          ...
                          <div className="flex items-center gap-2">
                            <Link to={`/phone/${phone.slug}`} className="text-primary text-xs font-bold hover:underline flex items-center gap-1">
                              View All Specs <ChevronRight size={11} />
                            </Link>
                            <Link to="/compare" className="glass border border-white/10 hover:border-primary/30 text-xs font-semibold px-2.5 py-1 rounded-lg transition-all flex items-center gap-1 text-muted-foreground hover:text-primary">
